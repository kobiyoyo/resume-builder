...
const Page = () => {
  let posts = [
    {
      ...
      content:
        "Create a standout resume that tells your professional story. With customizable templates and helpful prompts, you can easily highlight your achievements and skills to attract potential employers.",
    },
    {
      id: 2,
      ...
      content:
        "Simplify your job application process with a modern resume builder. Our platform allows you to create visually appealing resumes that effectively communicate your qualifications and experiences.",
    },

    {
      ...
      authorImg:
        "https://miro.medium.com/v2/resize:fit:1024/1*Nt39X5uC-FW8A94OtpgbJg.jpeg",
      authorName: "Elizabeth McGuire",
      date: "August 19th 2024",
      title: "Elevate Your Resume",
      content:
        "Enhance your job prospects with a polished resume. Our easy-to-use tools and expert tips guide you in crafting a document that captures attention and showcases your unique talents.",
    },

    {
      ...
      authorImg:
        "https://i.pinimg.com/originals/0f/3c/3c/0f3c3c76a16f10d43bf0b0c144cea281.png",
      authorName: "Lilah Guerrero",
      date: "November 3rd 2024",
      title: "Job Application Mastery",
      content:
        "Achieve resume writing success with our comprehensive platform. Build a professional resume that stands out in a competitive job market, ensuring you present your best self to employers.",
    },
  ...
  return (
    <section className="ml-16 mr-16 mb-16">
      <h1 className="text-6xl">The Blog</h1>
      <BigBlogCard
        key={mainBlog.id}
        img={mainBlog.img}
      ...
      <div className="grid mt-4 gap-x-8 gap-y-10 grid-cols-1 md:grid-cols-1 lg:grid-cols-2 2xl:grid-cols-4">
        {posts.map((blog) => (
          <BlogCard
            key={blog.id}
            img={blog.img}
